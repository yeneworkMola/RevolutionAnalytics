...
The objective of data analytics here is to predict the probability of default based on the other variables.  To predict the default, logistic regression, K mean clustering and decision tree models were developed.  
